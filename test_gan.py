...
parser.add_argument("--model", default="model/1024_8x_gan.pth", type=str, help="model path")
...
model8 = torch.load(opt.model, map_location=lambda st, loc: st.cuda(opt.gpu))["model"]
model4 = Net4x()
